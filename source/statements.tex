...
a \deflink{block scope}{basic.scope}. If the substatement in a
...
up in the \deflinkx{associated namespaces}{namespace!associated}{basic.lookup.argdep}.
\begin{note} Ordinary \link{unqualified lookup}{basic.lookup.unqual} is not
performed. \end{note}
\end{itemize}
\end{itemize}
...
other than \link{\tcode{main}}{basic.start.main}

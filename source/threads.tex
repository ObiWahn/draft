...
\pnum
\sync The completion of the thread represented by \tcode{*this} \deflinkx{synchronizes with}{synchronize with}{intro.multithread}
...
avoidance}{res.on.data.races}. For example, concurrent accesses through

...
\item
  ...
  \link{\libconcept{BidirectionalIterator}}{iterator.concept.bidir}.
...
\item
  ...
  expressions of the same type \tcode{I} which models
  \link{\tcode{BidirectionalIterator}}{iterator.concept.bidir}.
...
whose type models \link{\libconcept{Iterator}}{iterator.concept.iterator}.
...
\link{\libconcept{RandomAccessIterator}}{iterator.concept.random.access}.
...
\item Otherwise, if \tcode{T} is a specialization of class template
  \link{\tcode{initializer_list}}{support.initlist},
  \link{\tcode{set}}{set},
  \link{\tcode{multiset}}{multiset},
  \link{\tcode{unordered_set}}{unord.set},
  \link{\tcode{unordered_multiset}}{unord.multiset}, or
  \link{\tcode{match_results}}{re.results}, \tcode{false}.
...
a model of \link{\tcode{OutputIterator}}{iterator.concept.output}.
...
\begin{example}
The standard \link{containers}{containers} model \tcode{CommonRange}.
\end{example}
...
\link{range adaptor object}{range.adaptor.object}.
For some subexpressions \tcode{E} and \tcode{F}, the expression
...
\link{customization point object}{customization.point.object}.

...
\link{\tcode{vector}}{vector} instead of
\tcode{valarray}
for that class.
\end{note}
...
the corresponding \link{\tcode{thread} object}{thread.thread.class} at the time it
...
\begin{itemize}
  ...
  \item
    \tcode{q} is an lvalue
    satisfying the requirements of a \link{seed sequence}{rand.req.seedseq};
  \item
    \tcode{z} is a value

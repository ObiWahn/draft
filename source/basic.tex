...
\item it is
an \link{explicit instantiation}{temp.explicit} declaration, or
\item it is
...
\deflink{unevaluated operand}{expr.prop} or a subexpression thereof.
...
\item If \tcode{e} is a \link{class member access}{expr.ref} expression,
the set contains the potential results of
the object expression.
\item If \tcode{e} is a \link{pointer-to-member}{expr.mptr.oper}
...
\pnum
There can be more than one definition of a \link{class type}{class},
\link{enumeration type}{dcl.enum}, inline function
with external linkage\iref{dcl.inline}, inline variable with external
linkage\iref{dcl.inline}, \link{class template}{temp},
non-static \link{function template}{temp.fct},
concept\iref{temp.concept},
\link{static data member of a class template}{temp.static},
\link{member function of a class template}{temp.mem.func},
...
\link{overload resolution}{over.match} and after matching of partial
...
\link{hidden}{basic.scope.hiding}. \begin{note} A namespace name or a
...
complete \link{declarator}{dcl.decl} and before its
...
declarations of \tcode{m} in \tcode{X} and the \deflink{inline namespace set}{namespace.def} of
...
\item it is a \link{fundamental type}{basic.fundamental}; or

\item it is a \link{compound type}{basic.compound} other than a class or
enumeration, compounded exclusively from types that have linkage; or

\item it is a \link{cv-qualified}{basic.type.qualifier} version of a
...
\pnum
Two names that are \deflinkx{the same}{name!same}{basic} and that are declared
...
become \deflinkx{invalid pointer values}{invalid pointer value}{basic.compound}.
...
\item it is either a \deflink{closure type}{expr.prim.lambda.closure},
an \link{aggregate type}{dcl.init.aggr}, or
